    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-zinc-400">
          Candidates only—ownership is proven via private verification and admin approval.
        </p>
      </div>
        ...
        <Card>
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <div className="text-sm text-zinc-400">Review the breakdown. Submit a claim to start verification.</div>
            </div>
            <SecondaryButton
              onClick={async () => {
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="text-sm text-zinc-400 mt-1">
                        {m.foundItem?.category} • {m.foundItem?.location}
                      </div>
                    </div>
      ...
      <div className="text-xs text-zinc-500">
        Tip: Stronger reports (category/color/location/time) improve matching quality.
      </div>
    </div>
  );
}
